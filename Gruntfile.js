module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        less: {
            dev: {
                files: {
                    'web/public/css/app.css': 'web/src/styles/app.less'
                }
            },
            production: {
                options: {
                ...
                files: {
                    'web/public/css/app.min.css': 'web/src/styles/app.less'
                }
            }
        },
        templates: {
            dev: {
                ...
                files: {
                    'web/public/js/templates.js': 'web/src/templates/**/*.html'
                }
            },
            production: {
                options: {
    ...
    // Default task.
    grunt.registerTask('default', ['copy', 'templates:dev', 'less:dev', 'watch']);
